...
class SummarizeVideoUseCaseTest {
    ...
    @Test
    fun `execute should return summary when transcript and summary generation succeed`() = runTest {
        // Given
        val videoId = "123456"
    ...
    @Test
    fun `execute should use default prompt when prompt is null`() = runTest {
        // Given
        val videoId = "123456"
    ...
    @Test
    fun `execute should extract text from transcript correctly`() = runTest {
        // Given
        val videoId = "123456"
    ...
    @Test
    fun `execute should return null when summary generation returns null`() = runTest {
        // Given
        val videoId = "123456"
        val transcript = loadTranscript("transcripts/transcript-simple.txt")
    ...
    @Test
    fun `executeMultiple should process multiple video IDs correctly`() = runTest {
        // Given
    ...
    @Test
    fun `executeMultiple should use default prompt when prompt is null`() = runTest {
        // Given
    ...
    @Test
    fun `executeMultiple should handle three videos correctly`() = runTest {
        // Given
    ...
    @Test
    fun `executeMultiple should propagate exception from VimeoIdExtractor`() = runTest {
        // Given
    ...
    @Test
    fun `executeMultiple should return null when summary generation returns null`() = runTest {
        // Given
        val videoIds = listOf("123456")
    ...
    @Test
    fun `extractTranscriptText should handle empty transcript`() = runTest {
        // Given
        val videoId = "123456"
